...
function GoogleWidget() {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="group flex items-center gap-4 bg-white/18 backdrop-blur-lg border border-white/28 rounded-2xl px-6 py-4 hover:bg-white/24 transition-colors duration-300 shadow-[0_10px_28px_rgba(0,0,0,0.12)]"
    >
      <Image src="/img/google.png" alt="Google" width={80} height={26} className="shrink-0" />
      <div className="w-px h-8 bg-white/35 shrink-0" />
