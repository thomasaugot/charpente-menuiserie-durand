    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
        <div>
          <label
            htmlFor="name"
            className={`${dosisFont.className} text-dark-grey/70 text-sm font-semibold tracking-wide`}
          >
            Nom
          </label>
          <input
      ...
      {stateMessage && (
        <p
          className={`${dosisFont.className} text-dark-grey text-center text-sm font-semibold mt-3`}
        >
          {stateMessage}
        </p>
      )}
